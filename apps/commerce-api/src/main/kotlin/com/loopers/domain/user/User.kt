...
class User(@NaturalId val username: String, val name: String, val email: String, val gender: String, val birth: String) :
    ...
    init {
        ...
        runCatching { LocalDate.parse(birth, DATE_FORMATTER) }
    ...
    companion object {
        ...
        private val DATE_FORMATTER = DateTimeFormatter.ofPattern("yyyy-MM-dd").withResolverStyle(ResolverStyle.STRICT)
    }
}
